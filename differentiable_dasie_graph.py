...
def zernike_4(T):
    ...
    cartesian_radial = tf.math.sqrt(u_field**2 + v_field**2)
    cartesian_azimuth = tf.math.atan2(v_field, u_field)
    z = tf.math.sqrt(3.0)  * (cartesian_radial - 1)
    z = tf.cast(z, dtype=tf.complex128)
...
def zernike_7(T):
    ...
    cartesian_radial = tf.math.sqrt(u_field**2 + v_field**2)
    cartesian_azimuth = tf.math.atan2(v_field, u_field)
    z = tf.math.sqrt(8.0) * ((3 * (cartesian_radial**3)) - (2 * cartesian_radial)) * tf.math.sin(cartesian_azimuth)
    z = tf.cast(z, dtype=tf.complex128)
...
def zernike_8(T):
    ...
    cartesian_radial = tf.math.sqrt(u_field**2 + v_field**2)
    cartesian_azimuth = tf.math.atan2(v_field, u_field)
    z = tf.math.sqrt(8.0) * ((3 * (cartesian_radial**3)) - (2 * cartesian_radial)) * tf.math.cos(cartesian_azimuth)
    z = tf.cast(z, dtype=tf.complex128)
...
def zernike_9(T):
    ...
    cartesian_radial = tf.math.sqrt(u_field**2 + v_field**2)
    cartesian_azimuth = tf.math.atan2(v_field, u_field)
    z = tf.math.sqrt(8.0) * (cartesian_radial ** 3) * tf.math.cos(3 * cartesian_azimuth)
    z = tf.cast(z, dtype=tf.complex128)
...
def zernike_10(T):
    ...
    cartesian_radial = tf.math.sqrt(u_field**2 + v_field**2)
    cartesian_azimuth = tf.math.atan2(v_field, u_field)
    z = tf.math.sqrt(10.0) * (cartesian_radial ** 4) * tf.math.sin(4 * cartesian_azimuth)
    z = tf.cast(z, dtype=tf.complex128)
...
def zernike_11(T):
    ...
    cartesian_radial = tf.math.sqrt(u_field**2 + v_field**2)
    cartesian_azimuth = tf.math.atan2(v_field, u_field)
    z = tf.math.sqrt(10.0) * ((4 * (cartesian_radial ** 4)) - (3 * (cartesian_radial ** 2))) * tf.math.sin(2 * cartesian_azimuth)
    z = tf.cast(z, dtype=tf.complex128)
...
def zernike_12(T):
    ...
    cartesian_radial = tf.math.sqrt(u_field**2 + v_field**2)
    cartesian_azimuth = tf.math.atan2(v_field, u_field)
    z = tf.math.sqrt(10.0) * ((6 * (cartesian_radial ** 4)) - (6 * (cartesian_radial ** 2)) + 1)
    z = tf.cast(z, dtype=tf.complex128)
...
def zernike_13(T):
    ...
    cartesian_radial = tf.math.sqrt(u_field**2 + v_field**2)
    cartesian_azimuth = tf.math.atan2(v_field, u_field)
    z = tf.math.sqrt(10.0) * ((4 * (cartesian_radial ** 4)) - (3 * (cartesian_radial ** 2))) * tf.math.cos(2 * cartesian_azimuth)
    z = tf.cast(z, dtype=tf.complex128)
